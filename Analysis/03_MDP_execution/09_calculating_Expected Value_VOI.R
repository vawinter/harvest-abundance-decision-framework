...
load('C:/Users/vaw5154/OneDrive - The Pennsylvania State University/PhD/PSUTurkey/turkey_SDP/Results/Utility_Results_UpdatedPlots/all_utility_results.mat');
jan_apr_results = all_results;

% Load September results (average mast)
load('C:/Users/vaw5154/OneDrive - The Pennsylvania State University/PhD/PSUTurkey/turkey_SDP/Results/Sept_Mast_StateVar_avg/avg_all_utility_results.mat');
